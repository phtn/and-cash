              ...
              <div className='flex items-start gap-3'>
                ...
                <div className='flex-1'>
                  ...
                  <p className='text-sm text-muted-foreground'>
                    Please set{' '}
                    <code className='text-xs bg-background px-1.5 py-0.5 rounded'>NEXT_PUBLIC_SWAPPED_API_PK</code> in
                    your <code className='text-xs bg-background px-1.5 py-0.5 rounded'>.env.local</code> or{' '}
                    <code className='text-xs bg-background px-1.5 py-0.5 rounded'>.env</code> file.
                  </p>
                  <p className='text-xs text-muted-foreground mt-2'>
                    Example:{' '}
                    <code className='text-xs bg-background px-1.5 py-0.5 rounded'>
                      NEXT_PUBLIC_SWAPPED_API_PK=your_api_key_here
                    </code>
                  </p>
                </div>
              </div>
