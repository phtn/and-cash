...
const ConverterParamsContext = createContext<ConverterParamsContextValue | null>(null)
...
export function useConverterParams(): ConverterParamsContextValue {
  ...
  if (!context) {
    throw new Error('useConverterParams must be used within ConverterParamsProvider')
  }
  return context
}
